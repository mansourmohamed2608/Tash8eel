...
exports.ArabicTemplates = exports.SLOT_QUESTIONS = exports.ARABIC_TEMPLATES = void 0;
exports.fillTemplate = fillTemplate;
exports.ARABIC_TEMPLATES = {
    // Greetings
    GREETING: "أهلاً وسهلاً! 👋 أنا هنا لمساعدتك. إزاي أقدر أساعدك النهاردة؟",
    GREETING_RETURNING: "أهلاً بيك تاني {name}! 👋 نورتنا. إزاي أقدر أساعدك النهاردة؟",
    ...
    CART_SUMMARY: "السلة دلوقتي:\n{items}\n\nالمجموع: {subtotal} جنيه\n{discount_line}الإجمالي: {total} جنيه",
    CONFIRM_ORDER: "كده الطلب جاهز!\n\n{order_summary}\n\nتحب أأكد الطلب؟ (أيوه/لأ)",
    ORDER_CONFIRMED: "تمام! 🎉 الطلب #{order_number} اتأكد.\nهتوصلك رسالة بتفاصيل التوصيل.",
    // Delivery
    DELIVERY_BOOKED: "تم حجز التوصيل! 🚚\nرقم التتبع: {tracking_id}\nالتوصيل المتوقع: {estimated_date}",
    TRACKING_UPDATE: "تحديث الشحنة #{tracking_id}:\nالحالة: {status}",
    // Negotiation
    DISCOUNT_APPROVED: "ماشي! عملتلك خصم {discount}%! 🎁\nالسعر بعد الخصم: {final_price} جنيه",
    DISCOUNT_REJECTED: "للأسف مقدرش أعمل خصم أكتر من كده. أقصى خصم متاح هو {max_discount}%.",
    FREE_DELIVERY_OFFER: "لو ضفت منتجات بـ {amount_needed} جنيه كمان، التوصيل هيبقى مجاني! 🚚",
    // Follow-up
    FOLLOWUP_CHECK: "أهلاً! 👋 لسه مستني ردك على الطلب. محتاج أي مساعدة؟",
    FOLLOWUP_INCENTIVE: "عندنا عرض خاص ليك! 🎁 لو أكدت الطلب دلوقتي هتاخد خصم {discount}%!",
    ...
    FOLLOWUP_FINAL: "آخر تذكير! السلة بتاعتك لسه موجودة. لو محتاج حاجة تانية كلمني.",
    // Report
...
exports.SLOT_QUESTIONS = {
    product: exports.ARABIC_TEMPLATES.ASK_PRODUCT,
    quantity: exports.ARABIC_TEMPLATES.ASK_QUANTITY,
    size: exports.ARABIC_TEMPLATES.ASK_SIZE,
    color: exports.ARABIC_TEMPLATES.ASK_COLOR,
    options: exports.ARABIC_TEMPLATES.ASK_OPTIONS,
    substitution_preference: exports.ARABIC_TEMPLATES.ASK_SUBSTITUTION,
    customer_name: exports.ARABIC_TEMPLATES.ASK_NAME,
    phone: exports.ARABIC_TEMPLATES.ASK_PHONE,
    address_city: exports.ARABIC_TEMPLATES.ASK_ADDRESS_CITY,
    address_area: exports.ARABIC_TEMPLATES.ASK_ADDRESS_AREA,
    address_street: exports.ARABIC_TEMPLATES.ASK_ADDRESS_STREET,
    address_building: exports.ARABIC_TEMPLATES.ASK_ADDRESS_BUILDING,
    address_floor: exports.ARABIC_TEMPLATES.ASK_ADDRESS_FLOOR,
    address_landmark: exports.ARABIC_TEMPLATES.ASK_ADDRESS_LANDMARK,
};
// Alias for backward compatibility
exports.ArabicTemplates = exports.ARABIC_TEMPLATES;
