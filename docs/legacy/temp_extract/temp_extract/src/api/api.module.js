...
// Application imports
const llm_module_1 = require("../application/llm/llm.module");
const events_module_1 = require("../application/events/events.module");
const dlq_module_1 = require("../application/dlq/dlq.module");
const adapters_module_1 = require("../application/adapters/adapters.module");
const inbox_service_1 = require("../application/services/inbox.service");
let ApiModule = (() => {
    let _classDecorators = [(0, common_1.Module)({
            ...
            controllers: [
                ...
                controllers_1.MerchantsController,
                controllers_1.CatalogController,
                controllers_1.ConversationsController,
