import { Merchant, CreateMerchantInput, UpdateMerchantInput, MerchantTokenUsage } from "../entities/merchant.entity";
...
export declare const MERCHANT_REPOSITORY: unique symbol;
