...
export class CatalogRepository implements ICatalogRepository {
  ...
  async findBySku(merchantId: string, sku: string): Promise<CatalogItem | null> {
  ...
  async findByMerchantAndCategory(merchantId: string, category: string): Promise<CatalogItem[]> {
    const result = await this.pool.query(
  ...
  async searchByName(merchantId: string, query: string): Promise<CatalogItem[]> {
    const result = await this.pool.query(
  ...
  async findByName(name: string, merchantId: string): Promise<CatalogItem | null> {
