...
export class ShipmentRepository implements IShipmentRepository {
  ...
  async create(input: CreateShipmentInput): Promise<Shipment> {
    const id = generateId();
    const initialStatus = { status: 'pending', timestamp: new Date(), description: 'Shipment created' };
  ...
  async update(id: string, input: UpdateShipmentInput): Promise<Shipment | null> {
  ...
  async addStatusEntry(id: string, status: string, description?: string): Promise<Shipment | null> {
  ...
  async updateStatus(id: string, status: string, description?: string): Promise<Shipment | null> {
