  ...
  schema: {
    ...
    properties: {
        ...
        properties: {
          products: {
            ...
            items: {
              ...
              required: ['name', 'quantity', 'size', 'color', 'options', 'notes'],
          ...
          address: {
            ...
            required: ['city', 'area', 'street', 'building', 'floor', 'apartment', 'landmark', 'raw_text'],
            additionalProperties: false,
          },
          substitutionAllowed: { type: ['boolean', 'null'] },
          deliveryPreference: { type: ['string', 'null'] },
        },
        required: ['products', 'customerName', 'phone', 'address', 'substitutionAllowed', 'deliveryPreference'],
        additionalProperties: false,
      },
      missing_slots: {
        type: ['array', 'null'],
      ...
      negotiation: {
        type: ['object', 'null'],
        properties: {
          requestedDiscount: { type: ['number', 'null'], description: 'Discount percentage given (e.g., 10 for 10%)' },
    ...
    required: ['actionType', 'reply_ar', 'confidence', 'extracted_entities', 'missing_slots', 'negotiation', 'reasoning', 'delivery_fee'],
    additionalProperties: false,
  },
};
