import { 
  Controller, Post, Body, HttpCode, HttpStatus, Logger, Inject 
} from '@nestjs/common';
import { ApiTags, ApiOperation, ApiResponse } from '@nestjs/swagger';
import { CatalogUpsertDto, CatalogUpsertResponseDto, CatalogItemResponseDto } from '../dto/catalog.dto';
...
export class CatalogController {
  ...
  async upsertItems(@Body() dto: CatalogUpsertDto): Promise<CatalogUpsertResponseDto> {
