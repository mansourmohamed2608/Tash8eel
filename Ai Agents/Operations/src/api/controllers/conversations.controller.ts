...
export class ConversationsController {
  ...
  @ApiQuery({ name: 'includeMessages', description: 'Include message history', required: false })
  ...
  async listConversations(
    ...
    const result = paginated.map((conv: Conversation) => this.mapConversationToDto(conv, []));
  ...
  private mapConversationToDto(conversation: Conversation, messages: Message[]): ConversationResponseDto {
    return {
      id: conversation.id,
