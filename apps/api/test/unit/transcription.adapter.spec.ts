import {
  ...
  TranscriptionResult,
} from "../../src/application/adapters/transcription.adapter";
...
describe("TranscriptionAdapters", () => {
  describe("MockTranscriptionAdapter", () => {
    ...
    beforeEach(() => {
      ...
      adapter = new MockTranscriptionAdapter(configService);
    });
  ...
  describe("WhisperTranscriptionAdapter", () => {
    let adapter: WhisperTranscriptionAdapter;
    let configService: ConfigService;
    ...
    beforeEach(() => {
      ...
      adapter = new WhisperTranscriptionAdapter(configService);
    });
    ...
    describe("transcribe", () => {
      it("should throw error when API key is not configured", async () => {
        ...
        const noKeyAdapter = new WhisperTranscriptionAdapter(
          noKeyConfigService,
        );
        const audioBuffer = Buffer.from("mock audio");

        await expect(noKeyAdapter.transcribe(audioBuffer)).rejects.toThrow(
