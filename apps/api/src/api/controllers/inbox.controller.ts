...
import { MerchantApiKeyGuard } from "../../shared/guards";
...
export class InboxController {
  ...
  @SkipThrottle({ short: true }) // Skip short throttle, still applies long rate limit
  @ApiOperation({
  ...
  @ApiResponse({
    status: 429,
    description: "Token budget exceeded or rate limit",
  })
