...
// New DTO for merchant onboarding
export class MerchantOnboardingDto extends MerchantConfigDto {
  @ApiPropertyOptional({
    description: "Optional merchant ID (auto-generated if not provided)",
  })
  @IsString()
  @IsOptional()
  id?: string;
