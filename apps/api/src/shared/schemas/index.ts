...
export const CartItemSchema = z.object({
  ...
  size: z.string().optional(), // Clothes
  color: z.string().optional(), // Clothes
  hasColorOptions: z.boolean().optional(), // Clothes
  requiresSpiceLevel: z.boolean().optional(), // Food
  spiceLevel: z.string().optional(), // Food
});
...
export const CollectedInfoSchema = z.object({
  ...
  deliverySlot: z.string().optional(), // For supermarket time slot booking
