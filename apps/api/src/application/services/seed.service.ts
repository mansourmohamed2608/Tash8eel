  ...
  private async seedMerchantCore(client: any): Promise<number> {
    ...
    await client.query(
      ...
      VALUES ($1, 'متجر تشغيل التجريبي', 'CLOTHES',
        ...
        '{"businessInfo":{"name":"متجر تشغيل التجريبي","category":"ملابس وأزياء","description":"متجر ملابس متنوع يقدم أحدث صيحات الموضة للرجال والسيدات والأطفال بأسعار تنافسية","location":"القاهرة، مصر","phone":"+201012345678","workingHours":"من 9 الصبح لـ 10 بالليل يومياً ماعدا الجمعة من 2 الضهر","paymentMethods":["كاش","فيزا/ماستركارد","إنستاباي","فودافون كاش"],"returnPolicy":"استرجاع واستبدال خلال 14 يوم من تاريخ الشراء بالفاتورة الأصلية","supportedServices":["بيع ملابس","تغيير مقاسات","استرجاع واستبدال","توصيل للمنزل"],"unsupportedServices":["إصلاح ملابس","تفصيل","تأجير ملابس"]},"faqs":[{"id":"faq-1","question":"مواعيد الشغل إيه؟","answer":"من 9 الصبح لـ 10 بالليل كل يوم ماعدا الجمعة من 2 الضهر لـ 11 بالليل","category":"working_hours","isActive":true},{"id":"faq-2","question":"التوصيل بكام؟","answer":"القاهرة 30 جنيه، الجيزة 40 جنيه، إسكندرية 60 جنيه. التوصيل مجاني لأوردرات فوق 300 جنيه","category":"delivery","isActive":true},{"id":"faq-3","question":"طرق الدفع المتاحة إيه؟","answer":"بنقبل كاش عند الاستلام، فيزا وماستركارد، إنستاباي، وفودافون كاش","category":"payment","isActive":true},{"id":"faq-4","question":"سياسة الاسترجاع إيه؟","answer":"ممكن ترجع أو تستبدل المنتج خلال 14 يوم من الشراء بشرط وجود الفاتورة والمنتج في حالته الأصلية","category":"returns","isActive":true},{"id":"faq-5","question":"بيجي التوصيل في إمتى؟","answer":"التوصيل داخل القاهرة والجيزة في 2-3 أيام عمل، والمحافظات في 3-5 أيام عمل","category":"delivery","isActive":true},{"id":"faq-6","question":"فيه مقاسات كبيرة؟","answer":"أيوه، عندنا مقاسات من S لـ 3XL في معظم المنتجات","category":"sizing","isActive":true},{"id":"faq-7","question":"بتعملوا تغيير مقاسات؟","answer":"أيوه، ممكن تستبدل المقاس في أي فرع خلال 14 يوم من الشراء","category":"sizing","isActive":true},{"id":"faq-8","question":"فيه فروع تانية؟","answer":"عندنا فروع في مدينة نصر، المهندسين، ومول مصر. كمان بنوصل لكل أنحاء مصر","category":"branches","isActive":true}]}'::jsonb,
        'PRO',
