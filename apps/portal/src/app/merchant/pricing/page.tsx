...
const PLAN_COLORS: Record<string, string> = {
  ...
  GROWTH: "border-emerald-200",
  PRO: "border-teal-200",
  ENTERPRISE: "border-amber-200",
  CHAT_ONLY: "border-blue-200",
};
          ...
          <Card className="border-slate-200 bg-white shadow-sm">
            ...
            <CardContent className="space-y-3">
              {curatedFeatureAddOns.map((item) => (
                <div
                  key={item.code}
                  className="flex flex-col gap-3 rounded-xl border border-slate-200 bg-slate-50/60 p-3 sm:flex-row sm:items-start sm:justify-between"
                >
